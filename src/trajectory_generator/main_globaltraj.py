...
if use_lanes:
    file_paths["track_name"] = input_map + "_lane_" + str(lane_index)
else:
...
file_paths["mintime_export"] = os.path.join(file_paths["module"], "outputs", file_paths["track_name"] + "_" + "mintime")
file_paths["traj_race_export"] = os.path.join(file_paths["module"], "outputs", file_paths["track_name"] + "_" + "traj_race_cl.csv")
file_paths["traj_ltpl_export"] = os.path.join(file_paths["module"], "outputs", file_paths["track_name"] + "_" + "traj_ltpl_cl.csv")
file_paths["lap_time_mat_export"] = os.path.join(file_paths["module"], "outputs", file_paths["track_name"] + "_" + lap_time_mat_opts["file"])
